 ...
 * @author MPC
 */
public class Update_Equipment extends javax.swing.JFrame {

    /**
     * Creates new form Update_Equipment
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String da = "UPDATE equipment SET Equip_Name='"+En+"',Equip_Weight='"+Ew+"',Stock_Quant='"+sq+"',Buy_Price='"+bp+"',Total_Price='"+tp+"',Description='"+des+"' WHERE E_ID = '"+eid+"'";
            dc.St.executeUpdate(da);
            clear();
            JOptionPane.showMessageDialog(null, "Successfully Updated Equipment Details");
        } catch (Exception e) {
            System.out.println(e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_Equipment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
