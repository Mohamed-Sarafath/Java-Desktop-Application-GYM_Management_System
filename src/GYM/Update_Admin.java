...
public class Update_Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        searchA = new javax.swing.JButton();
        ...
        AFname.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        searchA.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        searchA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8_search_more_20px.png"))); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(38, 38, 38)
                                .addComponent(searchA))
                            .addComponent(sal, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(add, javax.swing.GroupLayout.PREFERRED_SIZE, 344, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(searchA, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(11, 11, 11)))
    ...
    private void searchAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchAActionPerformed
        ...
        int idn1 = Integer.parseInt(idn.getText()); //craeting var for Admin id text box through search button
         ...
         try
         {
             ...
             while(rs.next())
             {
                  AFname.setText(rs.getString("First_Name"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            String da = "UPDATE admin SET First_Name='"+Fn+"',Last_Name='"+Ln+"',Gender='"+gen+"',Age='"+ag+"',NIC='"+ic+"',Address='"+ad+"',Salary='"+sa+"',User_Name='"+Un+"',Password='"+pas+"',E_Mail='"+em+"',Contact_info='"+ci+"' WHERE Admin_ID = '"+idn1+"'";
            dc.St.executeUpdate(da);
            clear();
             JOptionPane.showMessageDialog(null, "Successfully Updated Admin Details");
        }
        catch (Exception e)
        {
            System.out.println(e);
    ...
    private javax.swing.JButton searchA;
